...
const Sheet: React.FC<Props> = ({ left, right }) => {
  return (
    <div
      className="mobile:w-11/12 mobile:h-full tablet:w-4/5 laptop:h-screen desktop:h-4/5 mobile:bg-gray-100 laptop:bg-gray-300 border-2 rounded-md flex items-center justify-center mobile:flex-col laptop:flex-row laptop:mt-5 mobile:p-0 laptop:pl-0 laptop:pr-2 laptop:pt-0 laptop:pb-2"
    >
      <div
